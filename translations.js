const translations = {
    en: {
        ...
        "tos-6-li1": "User IDs",
        "tos-6-li2": "Server IDs",
        "tos-6-li3": "Channel IDs",
        "tos-6-li4": "Command usage",
        ...
        "pp-1-text1": "This Privacy Policy explains how Aurora collects and uses data.",
        "pp-1-text2": "By using Aurora, you agree to this policy.",
        "pp-2-title": "2. Information We Collect",
        "pp-2-text": "Aurora may collect:",
        "pp-2-li1": "Discord User ID",
        "pp-2-li2": "Discord Server ID",
        "pp-2-li3": "Discord Channel ID",
        "pp-2-li4": "Command usage data",
        "pp-2-text2": "Aurora does not collect personal data.",
        "pp-3-title": "3. How Information Is Used",
        "pp-3-li1": "Providing functionality",
        "pp-3-li2": "Processing commands",
        "pp-3-li3": "Improving performance",
        "pp-3-li4": "Preventing abuse",
        "pp-4-title": "4. Data Storage",
        "pp-4-text": "Some data may be stored.",
        "pp-5-title": "5. Data Sharing",
        "pp-5-text": "Aurora does not share data.",
        "pp-6-title": "6. Data Security",
        "pp-6-text": "We use reasonable protection.",
        "pp-7-title": "7. Data Removal",
        "pp-7-text": "Users can request removal.",
        "pp-8-title": "8. Children's Privacy",
        "pp-8-text": "Not intended for underage users.",
        "pp-9-title": "9. Changes",
        "pp-9-text": "Policy may change.",
        "pp-10-title": "10. Contact",
        "pp-10-text": "Contact via Discord."
    },
    ...
    pl: {
        ...
        "tos-6-title": "6. Dane",
        "tos-6-li1": "Identyfikatory Użytkowników",
        "tos-6-li2": "Identyfikatory Serwerów",
        "tos-6-li3": "Identyfikatory Kanałów",
        "tos-6-li4": "Użycie poleceń",
        ...
        "pp-1-title": "1. Wprowadzenie",
        "pp-1-text1": "Ta polityka opisuje jak Aurora zbiera dane.",
        "pp-1-text2": "Korzystając z bota, zgadzasz się z polityką.",
        "pp-2-title": "2. Zbierane dane",
        "pp-2-text": "Aurora może zbierać:",
        "pp-2-li1": "ID użytkownika",
        "pp-2-li2": "ID serwera",
        "pp-2-li3": "ID kanału",
        "pp-2-li4": "Dane użycia komend",
        "pp-2-text2": "Aurora nie zbiera danych osobowych.",
        "pp-3-title": "3. Wykorzystanie danych",
        "pp-3-li1": "Działanie bota",
        "pp-3-li2": "Obsługa komend",
        "pp-3-li3": "Poprawa działania",
        "pp-3-li4": "Zapobieganie nadużyciom",
        "pp-4-title": "4. Przechowywanie danych",
        "pp-4-text": "Dane mogą być przechowywane.",
        "pp-5-title": "5. Udostępnianie danych",
        "pp-5-text": "Dane nie są udostępniane.",
        "pp-6-title": "6. Bezpieczeństwo",
        "pp-6-text": "Stosujemy zabezpieczenia.",
        "pp-7-title": "7. Usuwanie danych",
        "pp-7-text": "Można poprosić o usunięcie.",
        "pp-8-title": "8. Dzieci",
        "pp-8-text": "Nie dla osób poniżej wieku.",
        "pp-9-title": "9. Zmiany",
        "pp-9-text": "Polityka może się zmieniać.",
        "pp-10-title": "10. Kontakt",
        "pp-10-text": "Kontakt przez Discord."
    }
};
